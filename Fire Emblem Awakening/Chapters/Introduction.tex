...
\begin{itemize}
	...
	\item You are allowed to use a save file to start your run, with a pre-setup Avatar. Timing begins on Save File Selection. Timing ends when you select an option on \enemy{Grima}.
